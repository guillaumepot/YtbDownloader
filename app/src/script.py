...
def progress_function(stream, chunk, bytes_remaining) -> None:
    """
    Display the progress of a download.

    Args:
        stream (object): The stream object representing the file being downloaded.
        chunk (int): The size of each chunk being downloaded.
...
def control_link(link:str) -> None:
    """
...
def get_file(link:str, name:str, audio:bool=False) -> None:
    """
