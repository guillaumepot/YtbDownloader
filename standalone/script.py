...
def main(link, audio=False):
    # Control the link
    check_link = control_link(link)
    if check_link == False:
        return print("Modifier mauvais lien")
...
if __name__ == "__main__":
    link = input("insérer lien: \n")
    print("Choisir format: 1 - Video | 2 - Audio")
    format = input("format souhaité: \n")
    ...
    if format == "1":
        ...
        print("Mauvais format, saisir 1 ou 2")

    main(link, audio=audio)